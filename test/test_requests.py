...
def test_all(client: SyncNeispy):
    ...
    sctimetable = client.elsTimetable(
    ...
    academyinfo = client.acaInsTiInfo(ATPT_OFCDC_SC_CODE=AE)  # 교육청 코드로 학원및 교습소 정보 요청
    academy = academyinfo[0].ACA_NM  # 학교이름 출력

    scclass = client.classInfo(
