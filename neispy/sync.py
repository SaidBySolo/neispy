...
class SyncNeispyRequest:
    ...
    def get_elsTimetablebgs(self, params: Dict[str, Union[str, int]]):
        ...

    def get_misTimetable(self, params: Dict[str, Union[str, int]]):
        ...

    def get_misTimetablebgs(self, params: Dict[str, Union[str, int]]):
        ...

    def get_hisTimetable(self, params: Dict[str, Union[str, int]]):
        ...

    def get_hisTimetablebgs(self, params: Dict[str, Union[str, int]]):
        ...

    def get_spsTimetable(self, params: Dict[str, Union[str, int]]):
        ...

    def get_spsTimetablebgs(self, params: Dict[str, Union[str, int]]):
        ...
